...
const canListForSale = computed(() => authStore.hasRole('seller'))
        ...
        <div v-if="canListForSale" class="mt-6 p-4 border border-gray-300 rounded-2xl space-y-2">
          ...
          <div v-if="listForSale" class="space-y-2">
            ...
            <p class="text-xs text-gray-600">
              Listing confirms you attest rights to sell a personal-use license (seller-rights-v1).
            </p>
          </div>
        </div>
        <p v-else class="mt-4 text-xs text-gray-500">
          Enable selling from a pin page (eligibility + payment method) to list at create time.
        </p>
